...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseVentas" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('blackouts.create')}}">Registrar apagón</a>
                        <a class="collapse-item" href="{{ url('blackouts')}}">Ver apagones</a>
                        <a class="collapse-item" href="#">Mapa de apagones</a>
                        <a class="collapse-item" href="#">Ver estadisticas</a>
                    </div>
                </div>
            </li>
            ...
            <div class="sidebar-heading">Configuraciones</div><!-- Heading -->
            <li class="nav-item">
                ...
                <div id="collapseClientes" class="collapse" aria-labelledby="headingTracing" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ url('zonas')}}">Ver zonas</a>
                        <a class="collapse-item" href="{{ route('zonas.create')}}">Crear zonas</a>
                        <a class="collapse-item" href="#">Reportes de zonas</a>
                    </div>
                </div>
            </li>
            ...
            <div class="sidebar-card">
                ...
                <p class="text-center mb-2"><strong>Servicios</strong> es un producto desarrollado por!</p>
                <a class="btn btn-success btn-sm" href="https://mhconsultores.com.ve">M.H. Consultores, C.A.</a>
            </div>
        </ul>
        <!-- End of Sidebar -->
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <img class="img-profile rounded-circle" src="{{ asset('img/profile.jpeg') }}">
                            </a>
